...
import { a as v } from "@nf-internal/chunk-XTCCDCJT";
import * as r from "@angular/core";
import { InjectionToken as xt, inject as u, ElementRef as _t, NgZone as wt, Renderer2 as Et, input as kt, booleanAttribute as g, numberAttribute as Dt } from "@angular/core";
import { FocusMonitor as It } from "@angular/cdk/a11y";
import { _CdkPrivateStyleLoader as Mt } from "@angular/cdk/private";
...
var c = (function (e) { return e[e.FADING_IN = 0] = "FADING_IN", e[e.VISIBLE = 1] = "VISIBLE", e[e.FADING_OUT = 2] = "FADING_OUT", e[e.HIDDEN = 3] = "HIDDEN", e; })(c || {}), A = class {
    _renderer;
    element;
    config;
...
}, U = V({ passive: !0, capture: !0 }), R = class {
    _events = new Map;
    ...
    class e {
        ...
        static \u0275cmp = E.\u0275\u0275defineComponent({ type: e, selectors: [["ng-component"]], hostAttrs: ["mat-ripple-style-loader", ""], decls: 0, vars: 0, template: function (n, o) { }, styles: [`.mat-ripple {
  overflow: hidden;
  position: relative;
}
...
`], encapsulation: 2 });
    ...
    fadeInRipple(a, t, n = {}) { let o = this._containerRect = this._containerRect || this._containerElement.getBoundingClientRect(), s = v(v({}, h), n.animation); n.centered && (a = o.left + o.width / 2, t = o.top + o.height / 2); let d = n.radius || ut(a, t, o), f = a - o.left, S = t - o.top, l = s.enterDuration, m = document.createElement("div"); m.classList.add("mat-ripple-element"), m.style.left = `${f - d}px`, m.style.top = `${S - d}px`, m.style.height = `${d * 2}px`, m.style.width = `${d * 2}px`, n.color != null && (m.style.backgroundColor = n.color), m.style.transitionDuration = `${l}ms`, this._containerElement.appendChild(m); let O = window.getComputedStyle(m), it = O.transitionProperty, P = O.transitionDuration, I = it === "none" || P === "0s" || P === "0s, 0s" || o.width === 0 && o.height === 0, b = new A(this, m, n, I); m.style.transform = "scale3d(1, 1, 1)", b.state = c.FADING_IN, n.persistent || (this._mostRecentTransientRipple = b); let x = null; return !I && (l || s.exitDuration) && this._ngZone.runOutsideAngular(() => { let B = () => { x && (x.fallbackTimer = null), clearTimeout(L), this._finishRippleTransition(b); }, M = () => this._destroyRipple(b), L = setTimeout(M, l + 100); m.addEventListener("transitionend", B), m.addEventListener("transitioncancel", M), x = { onTransitionEnd: B, onTransitionCancel: M, fallbackTimer: L }; }), this._activeRipples.set(b, x), (I || !l) && this._finishRippleTransition(b), b; }
...
var Nt = { capture: !0 }, St = ["focus", "mousedown", "mouseenter", "touchstart"], z = "mat-ripple-loader-uninitialized", T = "mat-ripple-loader-class-name", Y = "mat-ripple-loader-centered", k = "mat-ripple-loader-disabled", X = (() => { class e {
    _document = p(pt);
    ...
    _eventCleanups;
    _hosts = new Map;
    constructor() { let t = p(ht).createRenderer(null, null); this._eventCleanups = this._ngZone.runOutsideAngular(() => St.map(n => t.listen(this._document, n, this._onInteraction, Nt))); }
    ngOnDestroy() { let t = this._hosts.keys(); for (let n of t)
        this.destroyRipple(n); this._eventCleanups.forEach(n => n()); }
    configureRipple(t, n) { t.setAttribute(z, this._globalRippleOptions?.namespace ?? ""), (n.className || !t.hasAttribute(T)) && t.setAttribute(T, n.className || ""), n.centered && t.setAttribute(Y, ""), n.disabled && t.setAttribute(k, ""); }
    setDisabled(t, n) { let o = this._hosts.get(t); o ? (o.target.rippleDisabled = n, !n && !o.hasSetUpEvents && (o.hasSetUpEvents = !0, o.renderer.setupTriggerEvents(t))) : n ? t.setAttribute(k, "") : t.removeAttribute(k); }
    _onInteraction = t => { let n = yt(t); if (n instanceof HTMLElement) {
        let o = n.closest(`[${z}="${this._globalRippleOptions?.namespace ?? ""}"]`);
        o && this._createRipple(o);
    } };
    _createRipple(t) { if (!this._document || this._hosts.has(t))
        return; t.querySelector(".mat-ripple")?.remove(); let n = this._document.createElement("span"); n.classList.add("mat-ripple", t.getAttribute(T)), t.append(n); let o = this._globalRippleOptions, s = this._animationsDisabled ? 0 : o?.animation?.enterDuration ?? h.enterDuration, d = this._animationsDisabled ? 0 : o?.animation?.exitDuration ?? h.exitDuration, f = { rippleDisabled: this._animationsDisabled || o?.disabled || t.hasAttribute(k), rippleConfig: { centered: t.hasAttribute(Y), terminateOnPointerUp: o?.terminateOnPointerUp, animation: { enterDuration: s, exitDuration: d } } }, S = new w(f, this._ngZone, n, this._platform, this._injector), l = !f.rippleDisabled; l && S.setupTriggerEvents(t), this._hosts.set(t, { target: f, renderer: S, hasSetUpEvents: l }), t.removeAttribute(z); }
...
var At = ["*", [["", "progressIndicator", ""]]], Rt = ["*", "[progressIndicator]"];
function zt(e, a) { e & 1 && (r.\u0275\u0275domElementStart(0, "div", 1), r.\u0275\u0275projection(1, 1), r.\u0275\u0275domElementEnd()); }
var W = new xt("MAT_BUTTON_CONFIG");
function Q(e) { return e == null ? void 0 : Dt(e); }
var y = (() => { class e {
    _elementRef = u(_t);
    _ngZone = u(wt);
    _animationsDisabled = _();
    ...
    showProgress = kt(!1, { transform: g });
    constructor() { u(Mt).load(K); let t = this._elementRef.nativeElement; this._isAnchor = t.tagName === "A", this.disabledInteractive = this._config?.disabledInteractive ?? !1, this.color = this._config?.color ?? null, this._rippleLoader?.configureRipple(t, { className: "mat-mdc-button-ripple" }); }
    ...
    class e extends y {
        ...
        static \u0275fac = function (n) { return new (n || e); };
        static \u0275cmp = r.\u0275\u0275defineComponent({ type: e, selectors: [["button", "mat-icon-button", ""], ["a", "mat-icon-button", ""], ["button", "matIconButton", ""], ["a", "matIconButton", ""]], hostAttrs: [1, "mdc-icon-button", "mat-mdc-icon-button"], exportAs: ["matButton", "matAnchor"], features: [r.\u0275\u0275InheritDefinitionFeature], ngContentSelectors: Rt, decls: 5, vars: 1, consts: [[1, "mat-mdc-button-persistent-ripple", "mdc-icon-button__ripple"], [1, "mat-mdc-button-progress-indicator-container"], [1, "mat-focus-indicator"], [1, "mat-mdc-button-touch-target"]], template: function (n, o) { n & 1 && (r.\u0275\u0275projectionDef(At), r.\u0275\u0275domElement(0, "span", 0), r.\u0275\u0275projection(1), r.\u0275\u0275conditionalCreate(2, zt, 2, 0, "div", 1), r.\u0275\u0275domElement(3, "span", 2)(4, "span", 3)), n & 2 && (r.\u0275\u0275advance(2), r.\u0275\u0275conditional(o.showProgress() ? 2 : -1)); }, styles: [`.mat-mdc-icon-button {
...
import { BidiModule as Ct } from "@angular/cdk/bidi";
import * as D from "@angular/core";
import "@angular/core";
var nt = (() => { class e {
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275mod = D.\u0275\u0275defineNgModule({ type: e });
    static \u0275inj = D.\u0275\u0275defineInjector({ imports: [Ct] });
} return e; })();
...
var C = [[["", 8, "material-icons", 3, "iconPositionEnd", ""], ["mat-icon", 3, "iconPositionEnd", ""], ["", "matButtonIcon", "", 3, "iconPositionEnd", ""]], "*", [["", "iconPositionEnd", "", 8, "material-icons"], ["mat-icon", "iconPositionEnd", ""], ["", "matButtonIcon", "", "iconPositionEnd", ""]], [["", "progressIndicator", ""]]], F = [".material-icons:not([iconPositionEnd]), mat-icon:not([iconPositionEnd]), [matButtonIcon]:not([iconPositionEnd])", "*", ".material-icons[iconPositionEnd], mat-icon[iconPositionEnd], [matButtonIcon][iconPositionEnd]", "[progressIndicator]"];
function Ft(e, a) { e & 1 && (i.\u0275\u0275domElementStart(0, "div", 2), i.\u0275\u0275projection(1, 3), i.\u0275\u0275domElementEnd()); }
function Ot(e, a) { e & 1 && (i.\u0275\u0275domElementStart(0, "div", 2), i.\u0275\u0275projection(1, 3), i.\u0275\u0275domElementEnd()); }
function Pt(e, a) { e & 1 && (i.\u0275\u0275domElementStart(0, "div", 2), i.\u0275\u0275projection(1, 3), i.\u0275\u0275domElementEnd()); }
var Bt = `.mat-mdc-fab-base {
  -webkit-user-select: none;
  user-select: none;
  position: relative;
  display: inline-flex;
...
`, et = new Map([["text", ["mat-mdc-button"]], ["filled", ["mdc-button--unelevated", "mat-mdc-unelevated-button"]], ["elevated", ["mdc-button--raised", "mat-mdc-raised-button"]], ["outlined", ["mdc-button--outlined", "mat-mdc-outlined-button"]], ["tonal", ["mat-tonal-button"]]]), Ht = (() => {
    class e extends y {
        ...
        static \u0275fac = function (n) { return new (n || e); };
        static \u0275cmp = i.\u0275\u0275defineComponent({ type: e, selectors: [["button", "matButton", ""], ["a", "matButton", ""], ["button", "mat-button", ""], ["button", "mat-raised-button", ""], ["button", "mat-flat-button", ""], ["button", "mat-stroked-button", ""], ["a", "mat-button", ""], ["a", "mat-raised-button", ""], ["a", "mat-flat-button", ""], ["a", "mat-stroked-button", ""]], hostAttrs: [1, "mdc-button"], inputs: { appearance: [0, "matButton", "appearance"] }, exportAs: ["matButton", "matAnchor"], features: [i.\u0275\u0275InheritDefinitionFeature], ngContentSelectors: F, decls: 8, vars: 5, consts: [[1, "mat-mdc-button-persistent-ripple"], [1, "mdc-button__label"], [1, "mat-mdc-button-progress-indicator-container"], [1, "mat-focus-indicator"], [1, "mat-mdc-button-touch-target"]], template: function (n, o) { n & 1 && (i.\u0275\u0275projectionDef(C), i.\u0275\u0275domElement(0, "span", 0), i.\u0275\u0275projection(1), i.\u0275\u0275domElementStart(2, "span", 1), i.\u0275\u0275projection(3, 1), i.\u0275\u0275domElementEnd(), i.\u0275\u0275projection(4, 2), i.\u0275\u0275conditionalCreate(5, Ft, 2, 0, "div", 2), i.\u0275\u0275domElement(6, "span", 3)(7, "span", 4)), n & 2 && (i.\u0275\u0275classProp("mdc-button__ripple", !o._isFab)("mdc-fab__ripple", o._isFab), i.\u0275\u0275advance(5), i.\u0275\u0275conditional(o.showProgress() ? 5 : -1)); }, styles: [`.mat-mdc-button-base {
  text-decoration: none;
}
...
var Yn = Ht, ot = new Lt("mat-mdc-fab-default-options", { providedIn: "root", factory: () => N }), N = { color: "accent" }, Zt = (() => {
    class e extends y {
        _options = at(ot, { optional: !0 });
        _isFab = !0;
        extended = !1;
        constructor() { super(), this._options = this._options || N, this.color = this._options.color || N.color; }
        static \u0275fac = function (n) { return new (n || e); };
        static \u0275cmp = i.\u0275\u0275defineComponent({ type: e, selectors: [["button", "mat-fab", ""], ["a", "mat-fab", ""], ["button", "matFab", ""], ["a", "matFab", ""]], hostAttrs: [1, "mdc-fab", "mat-mdc-fab-base", "mat-mdc-fab"], hostVars: 4, hostBindings: function (n, o) { n & 2 && i.\u0275\u0275classProp("mdc-fab--extended", o.extended)("mat-mdc-extended-fab", o.extended); }, inputs: { extended: [2, "extended", "extended", jt] }, exportAs: ["matButton", "matAnchor"], features: [i.\u0275\u0275InheritDefinitionFeature], ngContentSelectors: F, decls: 8, vars: 5, consts: [[1, "mat-mdc-button-persistent-ripple"], [1, "mdc-button__label"], [1, "mat-mdc-button-progress-indicator-container"], [1, "mat-focus-indicator"], [1, "mat-mdc-button-touch-target"]], template: function (n, o) { n & 1 && (i.\u0275\u0275projectionDef(C), i.\u0275\u0275domElement(0, "span", 0), i.\u0275\u0275projection(1), i.\u0275\u0275domElementStart(2, "span", 1), i.\u0275\u0275projection(3, 1), i.\u0275\u0275domElementEnd(), i.\u0275\u0275projection(4, 2), i.\u0275\u0275conditionalCreate(5, Ot, 2, 0, "div", 2), i.\u0275\u0275domElement(6, "span", 3)(7, "span", 4)), n & 2 && (i.\u0275\u0275classProp("mdc-button__ripple", !o._isFab)("mdc-fab__ripple", o._isFab), i.\u0275\u0275advance(5), i.\u0275\u0275conditional(o.showProgress() ? 5 : -1)); }, styles: [`.mat-mdc-fab-base {
  -webkit-user-select: none;
  user-select: none;
  position: relative;
  display: inline-flex;
