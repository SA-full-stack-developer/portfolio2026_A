import { a as m } from "@nf-internal/chunk-P7VGBIY2";
import { a as c, c as u } from "@nf-internal/chunk-MQ6KVUBG";
import { a as h } from "@nf-internal/chunk-DQ6Z6NC4";
import "@nf-internal/chunk-PZNONLPT";
import * as s from "@angular/core";
import { inject as o, NgZone as _, RendererFactory2 as v, ElementRef as g, EventEmitter as w, Renderer2 as H, DOCUMENT as y, booleanAttribute as E } from "@angular/core";
...
var p = (() => {
    class i {
        ...
        static \u0275cmp = s.\u0275\u0275defineComponent({ type: i, selectors: [["ng-component"]], hostAttrs: ["cdk-text-field-style-loader", ""], decls: 0, vars: 0, template: function (t, n) { }, styles: [`textarea.cdk-textarea-autosize {
  resize: none;
}
...
`], encapsulation: 2 });
    ...
    monitor(e) { if (!this._platform.isBrowser)
        ...
        return n.subject; let r = new f, a = "cdk-text-field-autofilled", d = l => { l.animationName === "cdk-text-field-autofill-start" && !t.classList.contains(a) ? (t.classList.add(a), this._ngZone.run(() => r.next({ target: l.target, isAutofilled: !0 }))) : l.animationName === "cdk-text-field-autofill-end" && t.classList.contains(a) && (t.classList.remove(a), this._ngZone.run(() => r.next({ target: l.target, isAutofilled: !1 }))); }, x = this._ngZone.runOutsideAngular(() => (t.classList.add("cdk-text-field-autofill-monitored"), this._renderer.listen(t, "animationstart", d, M))); return this._monitoredElements.set(t, { subject: r, unlisten: x }), r; }
    ...
    set minRows(e) { this._minRows = c(e), this._setMinHeight(); }
    get maxRows() { return this._maxRows; }
    set maxRows(e) { this._maxRows = c(e), this._setMaxHeight(); }
...
export { b as AutofillMonitor, Z as CdkAutofill, j as CdkTextareaAutosize, $ as TextFieldModule };
