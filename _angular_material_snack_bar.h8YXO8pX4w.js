import { d as v, k as g } from "@nf-internal/chunk-SPXCP4LA";
import { b as p } from "@nf-internal/chunk-U6VGVGKT";
import { a as d } from "@nf-internal/chunk-PZNONLPT";
import * as n from "@angular/core";
import { InjectionToken as S, inject as o, NgZone as D, ElementRef as E, ChangeDetectorRef as R, DOCUMENT as T, Injector as _, afterNextRender as y, TemplateRef as I } from "@angular/core";
import { _IdGenerator as O, LiveAnnouncer as P } from "@angular/cdk/a11y";
import { BreakpointObserver as j, Breakpoints as F } from "@angular/cdk/layout";
import { OverlayConfig as N, createGlobalPositionStrategy as L, createOverlayRef as z, OverlayModule as V } from "@angular/cdk/overlay";
import { Subject as m, of as q } from "rxjs";
import { Platform as H } from "@angular/cdk/platform";
import { BasePortalOutlet as Z, CdkPortalOutlet as A, ComponentPortal as x, TemplatePortal as Q, PortalModule as U } from "@angular/cdk/portal";
...
}, B = new S("MatSnackBarData"), h = class {
    politeness = "polite";
    announcementMessage = "";
    viewContainerRef;
    duration = 0;
...
`], encapsulation: 2 });
    ...
    class i extends Z {
        ...
        _label;
        _role;
        _liveElementId = o(O).getId("mat-snack-bar-container-live-");
...
`], encapsulation: 2, changeDetection: 1 });
    ...
    return i;
})(), at = new S("mat-snack-bar-default-options", { providedIn: "root", factory: () => new h }), it = (() => { class i {
    _live = o(P);
    _injector = o(_);
    _breakpointObserver = o(j);
    ...
    _attachSnackBarContainer(t, e) { let a = e && e.viewContainerRef && e.viewContainerRef.injector, s = _.create({ parent: a || this._injector, providers: [{ provide: h, useValue: e }] }), r = new x(this.snackBarContainerComponent, e.viewContainerRef, s), c = t.attach(r); return c.instance.snackBarConfig = e, c.instance; }
