import { a as b, c as G } from "@nf-internal/chunk-FLLAWZZ2";
import { b as q } from "@nf-internal/chunk-76MPVSD4";
import { b as X, d as Q } from "@nf-internal/chunk-N4SNQY5V";
import { a as De, b as J } from "@nf-internal/chunk-WUMUGF6A";
import { a as g } from "@nf-internal/chunk-ZVGPI6ZI";
...
import { b as z, c as $, d as f } from "@nf-internal/chunk-ZGWTKG5Z";
import { a as l } from "@nf-internal/chunk-7RHXFCZM";
import { a as M } from "@nf-internal/chunk-4CLCTAJ7";
import * as v from "@angular/core";
import { InjectionToken as te, inject as d, NgZone as ie, DOCUMENT as se, RendererFactory2 as Ne, ElementRef as Re, EventEmitter as Se } from "@angular/core";
import { BehaviorSubject as Pe, Subject as ee, of as Be } from "rxjs";
import { skip as je, distinctUntilChanged as Ke, takeUntil as Ue } from "rxjs/operators";
...
var ne = new te("cdk-input-modality-detector-options"), re = { ignoreKeys: [18, 17, 224, 91, 16] }, oe = 650, x = { passive: !0, capture: !0 }, ae = (() => { class s {
    ...
    constructor() { let e = d(ie), t = d(se), n = d(ne, { optional: !0 }); if (this._options = M(M({}, re), n), this.modalityDetected = this._modality.pipe(je(1)), this.modalityChanged = this.modalityDetected.pipe(Ke()), this._platform.isBrowser) {
        let r = d(Ne).createRenderer(null, null);
...
} return s; })(), I = (function (s) { return s[s.IMMEDIATE = 0] = "IMMEDIATE", s[s.EVENTUAL = 1] = "EVENTUAL", s; })(I || {}), ce = new te("cdk-focus-monitor-default-options"), E = Y({ passive: !0, capture: !0 }), de = (() => { class s {
    _ngZone = d(ie);
    _platform = d(l);
    _inputModalityDetector = d(ae);
    _origin = null;
    ...
    constructor() { let e = d(ce, { optional: !0 }); this._detectionMode = e?.detectionMode || I.IMMEDIATE; }
    ...
    _registerGlobalListeners(e) { if (!this._platform.isBrowser)
        return; let t = e.rootNode, n = this._rootNodeFocusListenerCount.get(t) || 0; n || this._ngZone.runOutsideAngular(() => { t.addEventListener("focus", this._rootNodeFocusAndBlurListener, E), t.addEventListener("blur", this._rootNodeFocusAndBlurListener, E); }), this._rootNodeFocusListenerCount.set(t, n + 1), ++this._monitoredElementCount === 1 && (this._ngZone.runOutsideAngular(() => { this._getWindow().addEventListener("focus", this._windowFocusListener); }), this._inputModalityDetector.modalityDetected.pipe(Ue(this._stopInputModalityDetector)).subscribe(r => { this._setOrigin(r, !0); })); }
...
import { inject as a, afterNextRender as We, NgZone as R, DOCUMENT as S, Injector as Ve, ElementRef as me, booleanAttribute as ue, InjectionToken as fe } from "@angular/core";
...
var y = class {
    ...
    _executeOnStable(i) { this._injector ? We(i, { injector: this._injector }) : setTimeout(i); }
}, ge = (() => { class s {
    _checker = a(P);
    _ngZone = a(R);
    _document = a(S);
    ...
    static \u0275fac = function (t) { return new (t || s); };
    static \u0275dir = c.\u0275\u0275defineDirective({ type: s, selectors: [["", "cdkTrapFocus", ""]], inputs: { enabled: [2, "cdkTrapFocus", "enabled", ue], autoCapture: [2, "cdkTrapFocusAutoCapture", "autoCapture", ue] }, exportAs: ["cdkTrapFocus"], features: [c.\u0275\u0275NgOnChangesFeature] });
...
import { inject as u, DOCUMENT as Le, APP_ID as yt, InjectionToken as At, NgZone as Et, Injector as Tt } from "@angular/core";
...
import { tap as ot, debounceTime as at, filter as ct, map as dt } from "rxjs/operators";
var ut = 200, p = class {
    ...
    constructor(i, e) { let t = typeof e?.debounceInterval == "number" ? e.debounceInterval : ut; e?.skipPredicate && (this._skipPredicateFn = e.skipPredicate), this.setItems(i), this._setupKeyHandler(t); }
    ...
    _setupKeyHandler(i) { this._letterKeyStream.pipe(ot(e => this._pressedLetters.push(e)), at(i), ct(() => this._pressedLetters.length > 0), dt(() => this._pressedLetters.join("").toLocaleUpperCase())).subscribe(e => { for (let t = 1; t < this._items.length + 1; t++) {
...
import { QueryList as ft, InjectionToken as pt } from "@angular/core";
...
function K(s) { return _t(s) ? s : mt(s); }
var T = class {
    _activeItemIndex = -1;
    _activeItem = null;
    ...
    constructor(i, e) { i instanceof ft ? (this._items = i.toArray(), i.changes.subscribe(t => this._itemsChanged(t.toArray()))) : bt(i) ? i.subscribe(t => this._itemsChanged(t)) : (this._items = i, this._initializeFocus()), typeof e.shouldActivationFollowFocus == "boolean" && (this._shouldActivationFollowFocus = e.shouldActivationFollowFocus), e.horizontalOrientation && (this._horizontalOrientation = e.horizontalOrientation), e.skipPredicate && (this._skipPredicateFn = e.skipPredicate), e.trackBy && (this._trackByFn = e.trackBy), typeof e.typeAheadDebounceInterval < "u" && this._setTypeAhead(e.typeAheadDebounceInterval); }
    change = new It;
    ...
    _expandCurrentItem() { this._activeItem && (this._isCurrentItemExpanded() ? K(this._activeItem.getChildren()).pipe(Fe(1)).subscribe(i => { let e = i.find(t => !this._skipPredicateFn(t)); e && this.focusItem(e); }) : this._activeItem.expand()); }
    ...
    _expandAllItemsAtCurrentItemLevel() { if (!this._activeItem)
        return; let i = this._activeItem.getParent(), e; i ? e = K(i.getChildren()) : e = vt(this._items.filter(t => t.getParent() === null)), e.pipe(Fe(1)).subscribe(t => { for (let n of t)
        n.expand(); }); }
    _activateCurrentItem() { this._activeItem?.activate(); }
}, we = new pt("tree-key-manager", { providedIn: "root", factory: () => (s, i) => new T(s, i) });
...
var Qi = "cdk-describedby-message-container", xe = "cdk-describedby-message", C = "cdk-describedby-host", H = 0, Ji = (() => { class s {
    _platform = u(l);
    _document = u(Le);
    _messageRegistry = new Map;
    _messagesContainer = null;
    _id = `${H++}`;
    constructor() { u(g).load(b), this._id = u(yt) + "-" + H++; }
    describe(e, t, n) { if (!this._canBeDescribed(e, t))
        return; let r = U(t, n); typeof t != "string" ? (Me(t, this._id), this._messageRegistry.set(r, { messageElement: t, referenceCount: 0 })) : this._messageRegistry.has(r) || this._createMessageElement(t, n), this._isElementDescribedByMessage(e, r) || this._addMessageReference(e, r); }
    removeDescription(e, t, n) { if (!t || !this._isElementNode(e))
        return; let r = U(t, n); if (this._isElementDescribedByMessage(e, r) && this._removeMessageReference(e, r), typeof t == "string") {
    ...
    _createMessageElement(e, t) { let n = this._document.createElement("div"); Me(n, this._id), n.textContent = e, t && n.setAttribute("role", t), this._createMessagesContainer(), this._messagesContainer.appendChild(n), this._messageRegistry.set(U(e, t), { messageElement: n, referenceCount: 0 }); }
...
function U(s, i) { return typeof s == "string" ? `${i || ""}/${s}` : s; }
...
var W = class {
    ...
    focusItem() { }
}, es = { provide: we, useFactory: () => () => new W }, V = class extends y {
    _focusTrapManager;
    _inertStrategy;
    get enabled() { return this._enabled; }
    ...
    _checker = u(P);
    _ngZone = u(Et);
    _focusTrapManager = u(Mt);
    _document = u(Le);
    _inertStrategy;
    _injector = u(Tt);
    constructor() { let e = u(wt, { optional: !0 }); this._inertStrategy = e || new Z; }
    create(e, t = { defer: !1 }) { let n; return typeof t == "boolean" ? n = { defer: t } : n = t, new V(e, this._checker, this._ngZone, this._document, this._focusTrapManager, this._inertStrategy, n, this._injector); }
    static \u0275fac = function (t) { return new (t || s); };
    static \u0275prov = F.\u0275\u0275defineInjectable({ token: s, factory: s.\u0275fac, providedIn: "root" });
} return s; })();
export { rt as A11yModule, B as ActiveDescendantKeyManager, Ji as AriaDescriber, C as CDK_DESCRIBEDBY_HOST_ATTRIBUTE, xe as CDK_DESCRIBEDBY_ID_PREFIX, nt as CdkAriaLive, He as CdkMonitorFocus, it as CdkTrapFocus, V as ConfigurableFocusTrap, ts as ConfigurableFocusTrapFactory, Z as EventListenerFocusTrapInertStrategy, ce as FOCUS_MONITOR_DEFAULT_OPTIONS, wt as FOCUS_TRAP_INERT_STRATEGY, j as FocusKeyManager, de as FocusMonitor, I as FocusMonitorDetectionMode, y as FocusTrap, ge as FocusTrapFactory, _ as HighContrastMode, ye as HighContrastModeDetector, re as INPUT_MODALITY_DETECTOR_DEFAULT_OPTIONS, ne as INPUT_MODALITY_DETECTOR_OPTIONS, ae as InputModalityDetector, P as InteractivityChecker, N as IsFocusableConfig, Ie as LIVE_ANNOUNCER_DEFAULT_OPTIONS, be as LIVE_ANNOUNCER_ELEMENT_TOKEN, m as ListKeyManager, ve as LiveAnnouncer, Qi as MESSAGES_CONTAINER_ID, es as NOOP_TREE_KEY_MANAGER_FACTORY_PROVIDER, W as NoopTreeKeyManager, we as TREE_KEY_MANAGER, T as TreeKeyManager, De as _IdGenerator, kt as addAriaReferencedId, k as getAriaReferenceIds, L as isFakeMousedownFromScreenReader, O as isFakeTouchstartFromScreenReader, Ft as removeAriaReferencedId };
