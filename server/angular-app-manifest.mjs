...
export default {
  ...
  assets: {
    ...
    'index.html': {size: 126819, hash: '51bcb17c459b01dc10f1dab4a3d157228a432cd55771eb33dd5f28bc0e94ffd9', text: () => import('./assets-chunks/index_html.mjs').then(m => m.default)},
