...
export default {
  ...
  assets: {
    ...
    'lab/index.html': {size: 121259, hash: '879436e0f93dbe4185d4321e27f7988c65497d71c1e82d551adab47fd2d45a3d', text: () => import('./assets-chunks/lab_index_html.mjs').then(m => m.default)},
