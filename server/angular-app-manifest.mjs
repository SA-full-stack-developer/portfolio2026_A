...
export default {
  ...
  assets: {
    ...
    'index.html': {size: 127506, hash: '7e4024d1802378816535a045d7fc4564cea0752b5b96cf52acd7555f34138a0f', text: () => import('./assets-chunks/index_html.mjs').then(m => m.default)},
