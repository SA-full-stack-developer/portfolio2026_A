import { a as bc, b as nt, f as Ac } from "@nf-internal/chunk-CIXSH7WF";
import { B as _c, E as Sc, F as ch, G as lh, H as Rc, I as uh, J as dh, K as fh, L as CM, a as ae, b as R, c as Si, f as wc, g as bi, n as qo, p as Ai, r as Ri, s as Ot, w as ki, x as sh, y as ah } from "@nf-internal/chunk-6ON3HIBT";
...
}, Oc = new xi("21.2.13"), Wc = (() => { let e = Oc.full; return `https://${e.includes("-next") || e.includes("-rc") || e === "0.0.0-PLACEHOLDER" ? "next" : `v${Oc.major}`}.angular.dev`; })();
...
function hA(e, t, n, o) { let r = e ? ["ng-version", "21.2.13"] : G_(t.selectors[0]), i = null, s = null, a = 0; if (n)
    for (let u of n)
